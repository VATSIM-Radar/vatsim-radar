...
- `app/utils/server/vatsim/kafka.ts` merges Kafka client/position/flight-plan events into `radarStorage.vatsim.kafka`; it also derives pilot vertical speed from timestamped altitude samples before the live data is published.
