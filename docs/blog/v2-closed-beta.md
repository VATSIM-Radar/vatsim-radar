...
VATSIM Radar version 2.0 is a partial overhaul of VATSIM Radar systems.
...
- Map is now infinite
- A lot of other changes and bug fixes listed in full (draft) [changelog](https://github.com/VATSIM-Radar/vatsim-radar/blob/next/CHANGELOG.md)
...
[VATSIM Radar Next](https://next.vatsim-radar.com/) is an environment where V2 is hosted, normally only accessed by Patreon supporters and members of the special Early Adopters program.
...
No. You are allowed to share everything you see on Next with everyone.
...
Access to Next will be revoked. Those who actively provide feedback and report bugs will be manually selected as Early Adopters for the development of v2.1.
