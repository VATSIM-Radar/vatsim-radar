...
[VATSIM Radar Next](https://next.vatsim-radar.com/) is an environment where V2 is hosted, normally only accessed by
Patreon supporters and members of the special Early Adopters program.
