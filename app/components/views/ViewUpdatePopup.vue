    ...
    features: [
        {
            ...
            list: [
                ...
                'Fixed procedures tab showing old sid/star after previous flight',
                'NOTAMs grouping',
                'Friends private mode',
                'natTrak direction arrow',
                'New aircraft icons by DotWallop',
                'Many other bug fixes and improvements, including bookings, performance and more',
            ],
        },
    ],
