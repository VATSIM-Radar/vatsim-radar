    ...
    >
        ...
        >
            <template v-if="!simpleMode">
                <ui-toggle v-model="showPilotStats">
                    Show pilots stats
                </ui-toggle>
                <ui-block-title class="aircraft_list_title">
...
import type { AirportPopupPilotStatus } from '~/composables/vatsim/airport';
import { useDataStore } from '~/composables/render/storage';
import { getPilotStatus, getTimeRemains, useShowPilotStats } from '~/composables/vatsim/pilots';
...
import AirportAircraftFilter from '~/components/features/vatsim/airport/AirportAircraftFilter.vue';
