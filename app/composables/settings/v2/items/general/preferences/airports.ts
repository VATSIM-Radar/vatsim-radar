...
export const settingsItemPreferencesAirports = globalComputed(() => makeSettingsItems(({ notLoggedIn }) => ({
    ...
    showZoomLimit: {
        title: 'Zoom Limit',
        description: 'Airports will always be decluttered and all existing will be hidden in case zoom is lower or equal this (lower = zoomed out)',
        type: 'select',
        items: [
            { value: 9 },
            { value: 8.5 },
            ...
            { value: 3.5 },
            { value: 3 },
            { text: 'Always show everything', value: 0 },
        ],
        value: getSettingValue('map.preferences.airports.showZoomLimit'),
        onChange: value => setSettingByKey('map.preferences.airports.showZoomLimit', value as number),
    },
    declutterIf: {
