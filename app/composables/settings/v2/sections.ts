                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            key: 'overlays',
                            title: 'Overlays',
                            items: [items.preferences.traffic.showFullRoute, items.preferences.traffic.showRouteDetails, items.preferences.traffic.toggleAircraftOverlays, items.preferences.traffic.showAirlineLogos, items.preferences.traffic.showCountryFlags, items.preferences.traffic.showRegistrationFlags],
                        },
                        {
                            key: 'traffic',
                            title: 'Traffic',
